...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ARYANSONIII/JanemanMusicBot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+jYiGke7kvWQzODUx")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+VT1Z97uv0_Q2NGQx")
...
START_IMG_URL = [os.getenv("START_IMG_URL")] if os.getenv("START_IMG_URL") else DEFAULT_IMG_LIST

HELP_IMG_URL = os.getenv("HELP_IMG_URL")
if not HELP_IMG_URL or not HELP_IMG_URL.startswith("http"):
    HELP_IMG_URL = random.choice(DEFAULT_IMG_LIST)

PING_IMG_URL = [os.getenv("PING_IMG_URL")] if os.getenv("PING_IMG_URL") else DEFAULT_IMG_LIST
STATS_IMG_URL = [os.getenv("STATS_IMG_URL")] if os.getenv("STATS_IMG_URL") else DEFAULT_IMG_LIST
